...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['titre'])) {
        ...
        $dossierPath = 'mangas/' . $titre_dossier;
        ...
        $stmt = $mysqli->prepare("INSERT INTO mangas (titre, genre, description, image) VALUES (?, ?, ?, ?)");
        ...
        // Insertion dans la base de données
        $stmt = $pdo->prepare("INSERT INTO m_chapitres (manga_id, numero, chemin) VALUES (?, ?, ?)");
